...
## P0 — Duplicate institution review
Inspect the database and code. Produce a report listing the 28 duplicate groups, the proposed canonical institution for each group, and any source/evidence foreign-key impact. Do not merge or delete records yet.
...
## Execution rule
Work on one task at a time. Start with analysis/report-only work. Do not deploy or add new collection sources until the independent release gate is PASS.
